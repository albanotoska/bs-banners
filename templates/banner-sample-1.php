...
?>
<figure class="bunny-banner bunny-sample-1">
  <img src="<?php  echo $image_src; ?>" alt="bunny-sample" class="<?php if( $checkbox =='true') {echo 'add_zoom';} ?>" />
  <figcaption>
    <h3  style="color:<?php echo $color; ?>;font-size: <?php echo $fontsize; ?>; background-color: <?php echo $accentcolor; ?>; "><?php echo $title; ?></h3>
  </figcaption>
